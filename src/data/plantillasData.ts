...
export const plantillasData: Plantilla[] = [
  {
    ...
    usageCount: 45,
    variables: [
      { name: 'arrendador_nombre', description: 'Nombre completo del arrendador', type: 'text', required: true },
  ...
  },
  {
    ...
    usageCount: 28,
    variables: [
      { name: 'nombre_demandante', description: 'Nombre del trabajador', type: 'text', required: true },
      { name: 'dni_demandante', description: 'DNI del trabajador', type: 'text', required: true },
      { name: 'nombre_demandado', description: 'Nombre de la empresa', type: 'text', required: true },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: 'nombre_demandante', description: 'Nombre del demandante', type: 'text', required: true },
  ...
  },
  {
    ...
    variables: [
      ...
      { name: 'materia_servicio', description: 'Materia del servicio', type: 'text', required: true },
